...
Write-Host "Found $($subnauticaGuids.Count) projects that should build for Subnautica"
...
# Add each project path (replace backslashes with forward slashes for JSON)
